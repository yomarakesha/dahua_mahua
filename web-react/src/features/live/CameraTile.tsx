...
interface Props {
  cam: Camera;
  /** Current ticking time string for the overlay (HH:MM:SS). */
  time: string;
 ...
 */
export function CameraTile({ cam, time, onOpen }: Props) {
    ...
    >
      ...
      {quality && (
        <>
          ...
          <div
            className="pointer-events-none absolute right-1.5 top-1.5 font-mono text-3xs text-[#cfe0d6]"
            style={{ textShadow: SHADOW }}
          >
            {time}
          </div>
